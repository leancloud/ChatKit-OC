 ...
 **/
@interface LCIMDurationRoot : LCIMRootObject
@end

#pragma mark - LCIMDuration

typedef GPB_ENUM(LCIMDuration_FieldNumber) {
  LCIMDuration_FieldNumber_Seconds = 1,
  LCIMDuration_FieldNumber_Nanos = 2,
};
 ...
 **/
@interface LCIMDuration : LCIMMessage
