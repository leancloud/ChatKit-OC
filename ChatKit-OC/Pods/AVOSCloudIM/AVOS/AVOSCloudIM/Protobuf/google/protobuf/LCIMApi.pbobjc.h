...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<LCIMMethod*> *methodsArray;
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<LCIMMixin*> *mixinsArray;
...
@interface LCIMMethod : LCIMMessage
...
///       ...
///     }
@interface LCIMMixin : LCIMMessage
