...
@interface LCIMStructRoot : LCIMRootObject
@end

#pragma mark - LCIMStruct

typedef GPB_ENUM(LCIMStruct_FieldNumber) {
  LCIMStruct_FieldNumber_Fields = 1,
};
...
@interface LCIMStruct : LCIMMessage

/// Unordered map of dynamically typed values.
@property(nonatomic, readwrite, strong, null_resettable) NSMutableDictionary<NSString*, LCIMValue*> *fields;
...
@property(nonatomic, readwrite, strong, null_resettable) LCIMStruct *structValue;

/// Represents a repeated `Value`.
@property(nonatomic, readwrite, strong, null_resettable) LCIMListValue *listValue;
...
@interface LCIMListValue : LCIMMessage

/// Repeated field of dynamically typed values.
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<LCIMValue*> *valuesArray;
