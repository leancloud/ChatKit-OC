...
//  Version 1.3.2
//
//  v0.7.15 Created by Nick Lockwood on 03/09/2010.
...
@implementation NSObject (LCCKSwipeView)

- (CGSize)swipeViewItemSize:(__unused LCCKSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused LCCKSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused LCCKSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused LCCKSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused LCCKSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused LCCKSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused LCCKSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused LCCKSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused LCCKSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused LCCKSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface LCCKSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<LCCKSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<LCCKSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(LCCKSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case LCCKSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case LCCKSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == LCCKSwipeViewAlignmentCenter)
        {
...
{
    //get number of items
    _numberOfItems = [_dataSource numberOfItemsInLCCKSwipeView:self];
