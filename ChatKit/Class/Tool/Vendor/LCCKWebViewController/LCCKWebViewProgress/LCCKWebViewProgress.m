...
const float LCCKInitialProgressValue = 0.1f;
const float LCCKInteractiveProgressValue = 0.5f;
const float LCCKFinalProgressValue = 0.9f;

@implementation LCCKWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < LCCKInitialProgressValue) {
        [self setProgress:LCCKInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? LCCKFinalProgressValue : LCCKInteractiveProgressValue;
