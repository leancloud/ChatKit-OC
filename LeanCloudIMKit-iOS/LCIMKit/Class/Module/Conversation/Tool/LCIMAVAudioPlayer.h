...
//  网络音频统一缓存在documents/com.LeanCloud.LCIMChat.LCIMAudioCache目录下
//  播放流程
...
@protocol LCIMAVAudioPlayerDelegate <NSObject>

- (void)audioPlayerStateDidChanged:(LCIMVoiceMessageState)audioPlayerState forIndex:(NSUInteger)index;

@end

@interface LCIMAVAudioPlayer : NSObject

@property (nonatomic, weak) id<LCIMAVAudioPlayerDelegate> delegate;
 ...
 */
@property (nonatomic, assign) LCIMVoiceMessageState audioPlayerState;
