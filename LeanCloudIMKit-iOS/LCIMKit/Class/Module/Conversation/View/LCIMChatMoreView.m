...
@interface LCIMChatMoreView ()<UIScrollViewDelegate>
...
@implementation LCIMChatMoreView
...
- (void)itemClickAction:(LCIMChatMoreItem *)item{
...
- (void)setupItems{
    ...
    [self.titles enumerateObjectsUsingBlock:^(NSString *obj, NSUInteger idx, BOOL *stop) {
        ...
        LCIMChatMoreItem *item = [[LCIMChatMoreItem alloc] initWithFrame:CGRectMake(startX, startY, self.itemSize.width, self.itemSize.height)];
...
- (void)setDataSource:(id<LCIMChatMoreViewDataSource>)dataSource{
