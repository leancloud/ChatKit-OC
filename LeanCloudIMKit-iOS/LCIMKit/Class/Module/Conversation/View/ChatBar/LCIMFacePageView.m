 ...
 *  预览表情显示的View
 */
@interface LCIMFacePreviewView : UIView
...
@implementation LCIMFacePreviewView
...
@interface LCIMFacePageView ()

@property (nonatomic, strong) NSMutableArray *imageViews;
@property (nonatomic, strong) LCIMFacePreviewView *facePreviewView;

@end

@implementation LCIMFacePageView
    ...
    if (self.imageViews && self.imageViews.count >= self.datas.count) {
        for (UIImageView *imageView in self.imageViews) {
            ...
            if (!imageView.hidden) {
                ...
                NSString *faceImageName = [LCIMFaceManager faceImageNameWithFaceID:[faceDict[kFaceIDKey] integerValue]];
...
- (UIImageView *)faceImageViewWithID:(NSString *)faceID{
    ...
    NSString *faceImageName = [LCIMFaceManager faceImageNameWithFaceID:[faceID integerValue]];
...
- (LCIMFacePreviewView *)facePreviewView{
    if (!_facePreviewView) {
        _facePreviewView = [[LCIMFacePreviewView alloc] initWithFrame:CGRectZero];
    }
