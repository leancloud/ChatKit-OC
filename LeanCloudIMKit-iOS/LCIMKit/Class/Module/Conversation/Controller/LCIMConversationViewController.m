...
@interface LCIMConversationViewController () <LCIMChatBarDelegate, LCIMAVAudioPlayerDelegate, LCIMChatMessageCellDelegate, LCIMConversationViewModelDelegate>
...
@property (nonatomic, strong) LCIMConversationViewModel *chatViewModel;
@property (nonatomic, copy) LCIMConversationHandler conversationHandler;
@property (nonatomic, copy) LCIMBooleanResultBlock loadHistoryMessagesHandler;
 ...
 *
 *  @return LCIMConversationViewModel
 */
- (LCIMConversationViewModel *)chatViewModel {
    if (_chatViewModel == nil) {
        LCIMConversationViewModel *chatViewModel = [[LCIMConversationViewModel alloc] initWithParentViewController:self];
...
- (void)sendImage:(UIImage *)image {
    ...
    CGSize size = ({
        ...
        CGFloat width = representationImage.size.width;
        CGFloat height = representationImage.size.height;
        CGSize size = CGSizeMake(width, height);
        size;
    });
    UIImage *thumbnailPhoto = [image lcck_imageByScalingAspectFillWithOriginSize:size];
    if (error == nil) {
...
#pragma mark - LCIMConversationViewModelDelegate
