...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
    ...
    self.recordingHUDImageView.image = [self getImageWithBundlePath:imageName];
}
...
- (void)setup {
    ...
    if (!_microPhoneImageView) {
        ...
        microPhoneImageView.image = [self getImageWithBundlePath:@"RecordingBkg"];
    ...
    if (!_recordingHUDImageView) {
        ...
        recordHUDImageView.image = [self getImageWithBundlePath:@"RecordingSignal001"];
    ...
    if (!_cancelRecordImageView) {
        ...
        cancelRecordImageView.image = [self getImageWithBundlePath:@"RecordCancel"];
...
- (UIImage *)getImageWithBundlePath:(NSString *)imageName {
