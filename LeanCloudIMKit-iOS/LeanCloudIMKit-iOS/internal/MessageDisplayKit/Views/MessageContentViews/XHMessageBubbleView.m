    ...
    if (self) {
        ...
        if (!_bubblePhotoImageView) {
            ...
            if (!_videoPlayImageView) {
                NSString *iconName = @"MessageBubble_Video";
                NSString *imageString = [NSString stringWithFormat:@"MessageBubble.bundle/%@", iconName];
                UIImage *image = [UIImage imageNamed:imageString];
                UIImageView *videoPlayImageView = [[UIImageView alloc] initWithImage:image];
        ...
        if (!_voiceUnreadDotImageView) {
            ...
            NSString *iconName = @"VoiceMessage_Unread";
            NSString *imageString = [NSString stringWithFormat:@"MessageBubble.bundle/%@", iconName];
            UIImage *image = [UIImage imageNamed:imageString];
            voiceUnreadDotImageView.image = image;
