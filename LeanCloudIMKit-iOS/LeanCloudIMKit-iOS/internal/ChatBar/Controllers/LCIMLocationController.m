...
@implementation LCIMLocationController
...
- (void)updateCenterLocation:(CLLocationCoordinate2D)centerCoordinate{
    ...
    [[LCIMLocationManager shareManager] reverseGeocodeWithCoordinate2D:centerCoordinate success:^(NSArray *placemarks) {
