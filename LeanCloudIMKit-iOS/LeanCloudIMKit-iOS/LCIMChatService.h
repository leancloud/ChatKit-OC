...
/*
 ...
 6. Implement `[id<LCIMChatService> getProfilesInBackgroundWithUserIds:callback]` in the subclass LCIMChatService, so LeanCloudIMKit can get user information by user id. Inculding `#import "LCIMChatService+Subclass.h"` or `#import "LeanCloudIMKit.h"` in the subclass interface file provides both asynchronous and asynchronous implementations automatically. `LCIMChatService_internal.h` file gives an example showing how to use AVUser as the user system.
 7. Implement `-[id<LCIMChatService> signatureWithClientId:conversationId:action:actionOnClientIds:]` in the subclass LCIMChatService.If implemeted, this method will be invoked automatically for pinning signature to these actions: open, start(create conversation), kick, invite.
