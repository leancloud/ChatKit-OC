...
+ (instancetype)initWithUserId:(NSString *)userId name:(NSString *)name avatorURL:(NSURL *)avatorURL {
    LCIMUser *user = [[LCIMUser alloc] initWithUserId:userId name:name avatorURL:avatorURL];
    return user;
}
...
- (id)copyWithZone:(NSZone *)zone {
    return [[LCIMUser alloc] initWithUserId:self.userId
                                       name:self.name
