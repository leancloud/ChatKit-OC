...
- (CYLTabBarController *)tabBarController {
    if (_tabBarController == nil) {
        ...
        LCIMProfileViewController *thirdViewController = [[LCIMProfileViewController alloc] init];
        UIViewController *thirdNavigationController = [[LCIMBaseNavigationController alloc]
