...
#import "LCIMPlusButtonSubclass.h"
#import "LCIMKitExample.h"

@interface LCIMPlusButtonSubclass () {
    CGFloat _buttonImageHeight;
}
@end
@implementation LCIMPlusButtonSubclass
...
+ (instancetype)plusButton
{
    ...
    LCIMPlusButtonSubclass *button = [LCIMPlusButtonSubclass buttonWithType:UIButtonTypeCustom];
